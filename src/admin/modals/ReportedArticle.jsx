...
const ArticleModal = ({open,onClose,report,reportedBy,image,reportedCar,reportedByImg,addMessage,reason}) => {
    ...
    <Box sx={style}>
        ...
        <div className='w-full h-full flex flex-col'>
            ...
            <div className='w-full h-min p-2 flex flex-row justify-around items-center'>

                <span className='font-semibold'>Reported car: {reportedCar}</span>
                <img className='rounded-md object-cover border-2 border-black w-[200px] h-[150px]' src={image} alt="" />
