export const countries = [
    ...
    { 
        code: 'BM', 
        label: 'Bermuda',
        cities: ['Hamilton', 'St. George\'s', 'Somerset Village', 'Mangrove Bay', 'Flatts Village']
    },
    { 
        code: 'BN', 
    ...
    { 
        code: 'BO', 
        label: 'Bolivia',
        cities: ['La Paz', 'Sucre', 'Santa Cruz de la Sierra', 'Cochabamba', 'Oruro']
    },
    { 
        code: 'BR', 
        label: 'Brazil',
    ...
    { 
        code: 'BW', 
        label: 'Botswana',
        cities: ['Gaborone', 'Francistown', 'Molepolole', 'Serowe', 'Selibe Phikwe']
    },
    { 
        code: 'BY', 
        label: 'Belarus',
    ...
    { 
        code: 'BZ', 
        label: 'Belize',
        cities: ['Belize City', 'San Ignacio', 'Belmopan', 'Orange Walk Town', 'Dangriga']
    },
    { 
        code: 'CA', 
        label: 'Canada',
    ...
    { 
        code: 'CW', 
        label: 'Curaçao',
        cities: ['Willemstad', 'Sint Michiel Liber', 'Sint Jozefsdal', 'Dorp Soto', 'Fontein']
    },
    { 
        code: 'CX', 
    ...
    { 
        ...
        cities: ['Santo Domingo', 'Santiago de los Caballeros', 'Santo Domingo Este', 'San Pedro de Macorís', 'La Romana']
    },
    { 
        code: 'DZ', 
        label: 'Algeria',
    ...
    { 
        code: 'EC', 
        label: 'Ecuador',
        cities: ['Quito', 'Guayaquil', 'Cuenca', 'Santo Domingo de los Colorados', 'Machala']
    },
    { 
        code: 'EE', 
        label: 'Estonia',
    ...
    { 
        code: 'GP', 
        label: 'Guadeloupe',
        cities: ['Les Abymes', 'Basse-Terre', 'Le Gosier', 'Sainte-Anne', 'Petit-Bourg']
    },
    { 
        code: 'GQ', 
    ...
    { 
        code: 'GT', 
        label: 'Guatemala',
        cities: ['Guatemala City', 'Mixco', 'Villa Nueva', 'Quetzaltenango', 'San Miguel Petapa']
    },
    { 
        code: 'GU', 
        label: 'Guam',
    ...
    { 
        code: 'HT', 
        label: 'Haiti',
        cities: ['Port-au-Prince', 'Carrefour', 'Delmas', 'Pétion-Ville', 'Port-de-Paix']
    },
    { 
        code: 'HU', 
        label: 'Hungary',
    ...
    { 
        code: 'IS', 
        label: 'Iceland',
        cities: ['Reykjavik', 'Kopavogur', 'Hafnarfjordur', 'Akureyri', 'Reykjanesbær']
    },
    { 
        code: 'IT', 
        label: 'Italy',
    ...
    { 
        code: 'KH', 
        label: 'Cambodia',
        cities: ['Phnom Penh', 'Siem Reap', 'Sihanoukville', 'Battambang', 'Kampong Cham']
    },
    { 
        code: 'KI', 
        label: 'Kiribati',
        cities: ['South Tarawa', 'Betio Village', 'Bairiki Village', 'Bikenibeu Village', 'Teaoraereke Village']
    },
    { 
        code: 'KM', 
        label: 'Comoros',
    ...
    { 
        ...
        cities: ['Basseterre', 'Charlestown', 'Dieppe Bay Town', 'Half Way Tree', 'Sandy Point Town']
    },
    { 
        code: 'KP', 
    ...
    { 
        code: 'KW', 
        label: 'Kuwait',
        cities: ['Kuwait City', 'Al Ahmadi', 'Hawalli', 'As Salimiyah', 'Sabah as Salim']
    },
    { 
        code: 'KY', 
    ...
    { 
        code: 'MQ', 
        label: 'Martinique',
        cities: ['Fort-de-France', 'Le Lamentin', 'Le Robert', 'Sainte-Marie', 'Ducos']
    },
    { 
        code: 'MR', 
        label: 'Mauritania',
    ...
    { 
        code: 'MX', 
        label: 'Mexico',
        cities: ['Mexico City', 'Iztapalapa', 'Ecatepec de Morelos', 'Guadalajara', 'Puebla City']
    },
    { 
        code: 'MY', 
        label: 'Malaysia',
        cities: ['Kuala Lumpur', 'Johor Bahru', 'Ipoh', 'Shah Alam', 'Petaling Jaya']
    },
    { 
        code: 'MZ', 
        label: 'Mozambique',
    ...
    { 
        code: 'RE', 
        label: 'Réunion',
        cities: ['Saint-Denis', 'Saint-Paul', 'Le Tampon', 'Saint-Pierre', 'Le Port']
    },
    { 
        code: 'RO', 
        label: 'Romania',
    ...
    { 
        code: 'SC', 
        label: 'Seychelles',
        cities: ['Victoria', 'Anse Boileau', 'Beau Vallon', 'Takamaka', 'Anse Royale']
    },
    { 
        code: 'SD', 
        label: 'Sudan',
    ...
    { 
        ...
        cities: ['Cockburn Town', 'Balfour Town', 'Bottle Creek', 'Blue Hills', 'Five Cays']
    },
    { 
        code: 'TD', 
        label: 'Chad',
    ...
    { 
        code: 'TH', 
        label: 'Thailand',
        cities: ['Bangkok', 'Nonthaburi', 'Nakhon Ratchasima', 'Chiang Mai', 'Hat Yai']
    },
    { 
        code: 'TJ', 
        label: 'Tajikistan',
    ...
    { 
        ...
        cities: ['Chaguanas', 'San Fernando', 'Port of Spain', 'Arima', 'Point Fortin']
    },
    { 
        code: 'TV', 
        label: 'Tuvalu',
    ...
    { 
        ...
        cities: ['Kingstown', 'Kingstown Park', 'Georgetown', 'Byera Village', 'Biabou']
    },
    { 
        code: 'VE', 
        label: 'Venezuela',
    ...
    { 
        ...
        cities: ['Road Town', 'East End', 'Spanish Town', 'Charlotte Amalie', 'West End']
    },
    { 
        code: 'VI', 
        label: 'Virgin Islands, U.S.',
        cities: ['Charlotte Amalie', 'Anna\'s Retreat', 'Charlotte Amalie West', 'Frederiksted', 'Cruz Bay']
    },
    { 
        code: 'VN', 
        label: 'Viet Nam',
